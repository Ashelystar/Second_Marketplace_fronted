...
import { getProductDetail, updateProduct, createProduct, saveToDraft, getCategoryList, uploadImage, type UpdateProductParams, type Category } from '@/api/goods'
...
const tradeModeOptions = [
  ...
  { label: '快递', value: 'shipping' as const },
